...
module.exports = [
  ...
  { id: 'wa-mozart-marche-turque-turkish-march-fingered', title: 'Turkish March',
    ...
    composer: 'Wolfgang Amadeus Mozart', difficulty: 'Advanced' },
  { id: 'liebestraum-no-3-in-a-major', title: 'Liebestraum No. 3',
    file: 'Liebestraum_No._3_in_A_Major.mxl', composer: 'Franz Liszt', difficulty: 'Not rated' },
];
